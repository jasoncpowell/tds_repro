...
| 2021-02-18 | [tds#119](https://github.com/elixir-ecto/tds/issues/119), [ecto_sql#302](https://github.com/elixir-ecto/ecto_sql/issues/302) | Related but different: raw `Repo.query/3` parameters get the wrong inferred type. Shows the same underlying fragility of inferring parameter types from values. |
